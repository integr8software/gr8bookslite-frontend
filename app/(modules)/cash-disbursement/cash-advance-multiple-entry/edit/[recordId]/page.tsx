...
import { CashAdvanceMultipleEntryActionModes } from "@/app/src/constants/modules/cash-disbursement/cash-advance-multiple-entry/CashAdvanceMultipleEntryConstants";
...
export default function CashDisbursementCashAdvanceMultipleEntryEditPage() {
  return <CashAdvanceMultipleEntryActionPage mode={CashAdvanceMultipleEntryActionModes.Edit} />;
}
