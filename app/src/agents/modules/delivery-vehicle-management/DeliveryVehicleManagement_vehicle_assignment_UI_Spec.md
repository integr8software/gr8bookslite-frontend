...
Vehicle Assignment reserves a compatible vehicle and delivery team for a load plan or trip and schedule window.
...
Load Planning supplies the requirement. Availability supplies candidate status. Trips & Dispatch consumes the confirmed assignment. User/Employee/Party data supplies the delivery team.
