...
- Frontend route: `gr8bookslite-frontend/app/(modules)/maintenance/payment-type/page.tsx`
...
```txt
app/(modules)/maintenance/payment-type/page.tsx
app/src/ui/modules/maintenance/payment-type/
app/src/hooks/modules/maintenance/payment-type/
app/src/services/modules/maintenance/payment-type/
app/src/data/modules/maintenance/financial-management/payment-type/
app/src/types/modules/maintenance/payment-type/
app/src/validations/modules/maintenance/payment-type/
```
