...
Stock Movement History is the immutable audit inquiry for posted warehouse and location movements.

## Current State

The route is a planning shell and must read the authoritative inventory movement ledger.

## Filters and Columns

- Movement date/time
- Item and quantity/unit
...
- Every movement references its source document.
- Posted history is not edited or deleted.
- Corrections appear as reversals or new movements.
- Company scope and Warehouse Access apply to inquiry and export.

## Connections

Movements may come from receipt, issue, putaway, warehouse/location transfer, count adjustment, return, or reversal documents.

## UI Requirements

- Date, warehouse, location, item, and document filters.
- Direct links to source documents and related warehouse operations.
- Clear inbound, outbound, and internal-movement indicators.

## Acceptance

Users can trace any displayed stock balance change to a unique posted document and actor.
