...
export const PettyCashFundItemColumnWidths: Record<PettyCashFundItemColumnId, number> = {
  ...
  totalAmountDue: 155,
  grossAmount: 130,
  responsibilityCenterCode: 180,
  responsibilityCenterName: 220,
};
...
export const PettyCashFundEntryEwtCodeOptions: AppAdvancedDropdownOption[] = [
  { label: "10%", name: "W10", value: "W10" },
  { label: "5%", name: "W05", value: "W05" },
  { label: "1%", name: "WV01", value: "WV01" },
  { label: "2%", name: "WV02", value: "WV02" },
];
