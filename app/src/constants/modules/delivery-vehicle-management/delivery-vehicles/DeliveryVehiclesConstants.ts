...
export const DeliveryVehiclesConfig: DeliveryVehicleModuleConfig = {
  ...
  fields: [
    ...
    { key: "cargoCapacity", label: "Cargo capacity", required: true, type: "number", defaultValue: "18" },
    { key: "capacityUnit", label: "Capacity unit", required: true, type: "select", options: ["m³", "ft³"], defaultValue: "m³" },
  ],
  tableFieldKeys: ["plateNumber", "vehicleType", "cargoCapacity", "capacityUnit", "baseWarehouse", "registrationExpiry"],
