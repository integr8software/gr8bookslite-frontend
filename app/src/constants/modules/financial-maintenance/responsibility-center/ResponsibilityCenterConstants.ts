...
export const ResponsibilityCenterApiPath = "/maintenance/financial-management/responsibility-centers";

export const ResponsibilityCenterTablePaginationStorageKey = "maintenance:financial-management:responsibility-center";
export const ResponsibilityCenterTablePreferencesStorageKey = "gr8booksneo:responsibility-center:table-preferences";
export const ResponsibilityCenterTablePreferencesModuleKey = "maintenance:responsibility-center";
export const ResponsibilityCenterDefaultSorting: SortingState = [{ id: "name", desc: false }];
...
export const ResponsibilityCenterDefaultColumnOrder = ResponsibilityCenterTableColumns.map((column) =>
  "key" in column ? column.key : "actions",
);

export const ResponsibilityCenterTreeColumnOrder = ResponsibilityCenterDefaultColumnOrder.filter((columnId) => columnId !== "parentId");

export const ResponsibilityCenterAuditColumnOrder = ["createdBy", "createdAt", "updatedBy", "updatedAt"];
...
export const ResponsibilityCenterTypeDefinitions: ResponsibilityCenterTypeDefinition[] = [
  {
    ...
    reportExamples: ["Trial Balance by Department", "Budget vs Actual by Department"],
  },
  {
    type: "Branch",
    origin: "User-defined",
    ...
    reportExamples: ["Income Statement by Branch", "Profit and Loss per Branch"],
  },
  {
    type: "Project",
    origin: "User-defined",
  ...
  },
  {
    ...
    reportExamples: ["Profit by Business Unit", "Gross Profit Analysis"],
  },
  {
    type: "Salesman",
    origin: "User-defined",
  ...
  },
  {
    ...
    reportExamples: ["Warehouse Expense Analysis", "Inventory Movement by Warehouse"],
  },
  {
    type: "Division",
    origin: "User-defined",
...
export const ResponsibilityCenterActionCopy = {
  add: {
    ...
    description: "Create an organizational unit for accountability, budgeting, and financial reporting.",
  },
  edit: {
    title: "Edit Responsibility Center",
    description: "Update center ownership, hierarchy, and reporting status.",
  },
  view: {
    title: "View Responsibility Center",
    description: "Review organizational hierarchy and financial accountability settings.",
  },
} as const;
