...
export const ItemAttributesDescription =
	"Maintain reusable item attributes and values assigned to item records.";

export const ItemAttributesDrawerFormId = "item-attributes-drawer-form";

export const ItemAttributesPaginationStorageKey =
...
export const ItemAttributesDefaultSorting: SortingState = [
	{ id: "name", desc: false },
];
