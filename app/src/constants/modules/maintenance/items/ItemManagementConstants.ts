...
export const ItemCategoryPaginationStorageKey = "maintenance.items.item-category.classification";
...
export const ItemWarehouseOptions = ["Main Warehouse", "North Warehouse"] as const;
...
export const ItemsExportColumns: ModuleTableExportColumn<ItemRecord>[] = ItemsTableColumns.flatMap(
  (column) =>
    "key" in column
      ? [
          {
...
export const ItemsFormPageCopy = {
  ...
  edit: {
    title: "Edit Item",
    description: "Update classification, behavior, supplier, inventory, pricing, and tax details.",
  },
  view: {
    title: "Item",
    description: "Review item master information, supplier links, and inventory setup.",
  },
} as const;
