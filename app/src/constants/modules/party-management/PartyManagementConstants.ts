...
export const PartyManagementHref =
...
export const PartyManagementTableColumns = [
	{ key: "partyCodeNo", label: "Code", className: "w-[10rem]" },
	...
	{ key: "atcCode", label: "ATC Code", className: "w-[10rem]" },
	{ key: "contact", label: "Contact", className: "w-[18rem]" },
	{
		label: "Actions",
