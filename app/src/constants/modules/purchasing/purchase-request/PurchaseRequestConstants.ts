...
export const PurchaseRequestTablePaginationStorageKey = "purchasing.purchase-request";

export const PurchaseRequestTypeOptions = ["Goods", "Services", "Assets"] as const;

export const PurchaseRequestStatusOptions: PurchaseRequestStatus[] = ["Draft", "For Approval", "Posted", "Disapproved", "Cancelled"];
...
export const PurchaseRequestFormPageCopy = {
  add: {
    ...
    description: "Capture supplier, project, currency, and item request details, then preview the printable purchase request.",
  },
  edit: {
