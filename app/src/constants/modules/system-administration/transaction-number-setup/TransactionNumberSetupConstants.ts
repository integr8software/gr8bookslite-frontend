...
export const TransactionNumberSetupHref = "/system-administration/transaction-number-setup";

export const TransactionNumberSetupPaginationStorageKey =
  "system-administration.transaction-number-setup";
export const TransactionNumberAllScopesFilter = "any";
...
export const TransactionNumberScopeFilterOptions = [
  { label: "All Scopes", value: TransactionNumberAllScopesFilter },
  { label: "All Branches", value: "all" },
  { label: "Separate per Branch", value: "branch" },
] as const satisfies ReadonlyArray<{
  label: string;
  value: TransactionNumberScope | typeof TransactionNumberAllScopesFilter;
}>;
