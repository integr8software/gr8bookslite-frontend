...
export const ApproverAssignmentToneByType: Record<ApproverAssignmentType, string> = {
...
export const ApproverStatusToneByStatus: Record<ApproverCoverageStatus, string> = {
