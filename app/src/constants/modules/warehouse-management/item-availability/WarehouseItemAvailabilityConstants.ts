import type {
  WarehouseItemAvailabilityConfig,
...
export const WarehouseItemAvailabilityConfigs: Record<
  WarehouseItemAvailabilityModule,
  WarehouseItemAvailabilityConfig
> = {
...
export const WarehouseItemAvailabilityPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseItemAvailabilityConfig, "emptyDescription">,
): WarehouseItemAvailabilityConfig {
  return {
    ...value,
