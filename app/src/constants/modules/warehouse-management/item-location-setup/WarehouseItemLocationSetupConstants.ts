import type {
  WarehouseItemLocationSetupConfig,
...
export const WarehouseItemLocationSetupConfigs: Record<
  WarehouseItemLocationSetupModule,
  WarehouseItemLocationSetupConfig
> = {
...
export const WarehouseItemLocationSetupPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseItemLocationSetupConfig, "emptyDescription">,
): WarehouseItemLocationSetupConfig {
  return {
    ...value,
