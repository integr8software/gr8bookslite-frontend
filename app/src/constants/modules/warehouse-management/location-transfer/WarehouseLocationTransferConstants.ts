import type {
  WarehouseLocationTransferConfig,
...
export const WarehouseLocationTransferConfigs: Record<
  WarehouseLocationTransferModule,
  WarehouseLocationTransferConfig
> = {
...
export const WarehouseLocationTransferPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseLocationTransferConfig, "emptyDescription">,
): WarehouseLocationTransferConfig {
  return {
    ...value,
