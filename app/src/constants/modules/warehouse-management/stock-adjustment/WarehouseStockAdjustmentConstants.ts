import type {
  WarehouseStockAdjustmentConfig,
...
export const WarehouseStockAdjustmentConfigs: Record<
  WarehouseStockAdjustmentModule,
  WarehouseStockAdjustmentConfig
> = {
...
export const WarehouseStockAdjustmentPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseStockAdjustmentConfig, "emptyDescription">,
): WarehouseStockAdjustmentConfig {
  return {
    ...value,
