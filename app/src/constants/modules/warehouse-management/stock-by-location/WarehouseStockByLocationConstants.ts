import type {
  WarehouseStockByLocationConfig,
...
export const WarehouseStockByLocationConfigs: Record<
  WarehouseStockByLocationModule,
  WarehouseStockByLocationConfig
> = {
...
export const WarehouseStockByLocationPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseStockByLocationConfig, "emptyDescription">,
): WarehouseStockByLocationConfig {
  return {
    ...value,
