import type {
  WarehouseStockByWarehouseConfig,
...
export const WarehouseStockByWarehouseConfigs: Record<
  WarehouseStockByWarehouseModule,
  WarehouseStockByWarehouseConfig
> = {
...
export const WarehouseStockByWarehousePaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseStockByWarehouseConfig, "emptyDescription">,
): WarehouseStockByWarehouseConfig {
  return {
    ...value,
