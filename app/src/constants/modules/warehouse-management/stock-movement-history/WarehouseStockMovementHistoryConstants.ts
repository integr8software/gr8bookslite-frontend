import type {
  WarehouseStockMovementHistoryConfig,
...
export const WarehouseStockMovementHistoryConfigs: Record<
  WarehouseStockMovementHistoryModule,
  WarehouseStockMovementHistoryConfig
> = {
...
export const WarehouseStockMovementHistoryPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseStockMovementHistoryConfig, "emptyDescription">,
): WarehouseStockMovementHistoryConfig {
  return {
    ...value,
