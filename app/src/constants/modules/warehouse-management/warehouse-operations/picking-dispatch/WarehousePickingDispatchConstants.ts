...
export const WarehousePickingDispatchPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehousePickingDispatchConfig, "apiPath" | "emptyDescription">,
): WarehousePickingDispatchConfig {
  return {
    ...value,
