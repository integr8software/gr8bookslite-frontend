...
export const WarehouseReceivingPutawayPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseReceivingPutawayConfig, "apiPath" | "emptyDescription">,
): WarehouseReceivingPutawayConfig {
  return {
    ...value,
