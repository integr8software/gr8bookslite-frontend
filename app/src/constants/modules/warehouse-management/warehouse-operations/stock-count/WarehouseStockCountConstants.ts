...
export const WarehouseStockCountConfigs: Record<
  WarehouseStockCountModule,
  WarehouseStockCountConfig
> = {
...
export const WarehouseStockCountPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseStockCountConfig, "apiPath" | "emptyDescription">,
): WarehouseStockCountConfig {
  return {
    ...value,
