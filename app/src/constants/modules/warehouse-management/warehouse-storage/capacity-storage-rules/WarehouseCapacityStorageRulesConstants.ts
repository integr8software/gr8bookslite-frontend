import type {
  WarehouseCapacityStorageRulesConfig,
...
export const WarehouseCapacityStorageRulesConfigs: Record<
  WarehouseCapacityStorageRulesModule,
  WarehouseCapacityStorageRulesConfig
> = {
...
export const WarehouseCapacityStorageRulesPaginationStorageKey = "warehouse-management-workspace";
...
function config(
  value: Omit<WarehouseCapacityStorageRulesConfig, "apiPath" | "emptyDescription">,
): WarehouseCapacityStorageRulesConfig {
  return {
    ...value,
    apiPath: `/maintenance/warehouse-management/${value.module}`,
