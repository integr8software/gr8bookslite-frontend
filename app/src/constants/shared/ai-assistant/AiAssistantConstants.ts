export const AiAssistantPurchaseRequestPrefillStorageKey = "gr8books.aiAssistant.purchaseRequestPrefill";

export const AiAssistantSalesQuotationPrefillStorageKey = "gr8books.aiAssistant.salesQuotationPrefill";

export const AiAssistantTermsMaintenancePendingActionStorageKey = "gr8books.aiAssistant.TermsMaintenancePendingAction";

export const AiAssistantTermsMaintenanceActionEvent = "gr8books:ai-assistant:terms-maintenance-action";

export const AiAssistantChatMessagesStorageKey = "gr8books.aiAssistant.chatMessages";

export const AiAssistantChatOpenStorageKey = "gr8books.aiAssistant.isOpen";

export const AiAssistantLauncherPositionStorageKey = "gr8books.aiAssistant.launcherPosition";

export const AiAssistantChatStorageVersionKey = "gr8books.aiAssistant.chatStorageVersion";
...
export const AiAssistantSpeechRecognitionUnsupportedMessage = "Voice input is not supported in this browser.";

export const AiAssistantAutomaticModeUnsupportedMessage = "Automatic voice mode is not supported in this browser.";

export const AiAssistantVoiceReplyUnsupportedMessage = "Voice replies are not supported in this browser.";
...
export const AiAssistantLauncherCorner = {
  TopLeft: "top-left",
  TopRight: "top-right",
