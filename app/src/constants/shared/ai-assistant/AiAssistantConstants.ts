...
export const AiAssistantWelcomeMessage =
	"Hi, I'm Neo AI. I can explain Gr8BooksLite modules and open the right page for you. How can I help?";

export const AiAssistantInputPlaceholder =
	"Ask: open Purchase Request";
