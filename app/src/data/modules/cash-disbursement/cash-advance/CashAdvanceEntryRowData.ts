...
export function getCashAdvanceResponsibilityCenterCode(responsibilityCenter: string) {
  return responsibilityCenter;
}

export function moveCashAdvanceColumnId(currentColumnIds: string[], fromColumnId: string, toColumnId: string) {
...
export function updateCashAdvanceVisibleColumnIds<TRow extends { id: string }>(
