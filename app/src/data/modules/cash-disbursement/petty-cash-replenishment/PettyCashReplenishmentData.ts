...
export const PettyCashReplenishmentRecords: PettyCashReplenishmentRecord[] = [
  {
    id: "1",
...
export const PettyCashReplenishmentInitialFormValues: PettyCashReplenishmentFormValues =
  {
    documentDate: "2026-05-21",
    projectName: "",
    projectRef: "",
...
export const PettyCashReplenishmentInitialEntries: PettyCashReplenishmentEntry[] =
  [
    {
      id: "1",
...
export function createEmptyPettyCashReplenishmentEntry(): PettyCashReplenishmentEntry {
  return {
    id: String(Date.now()),
    pettyCashDate: "",
    pettyCashNo: "",
...
export function calculatePettyCashReplenishmentTotals(
