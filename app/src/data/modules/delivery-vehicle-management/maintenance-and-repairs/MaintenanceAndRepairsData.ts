...
import type { MaintenanceWorkOrderRecord } from "@/app/src/types/modules/delivery-vehicle-management/maintenance-and-repairs/MaintenanceAndRepairsTypes";

export const MaintenanceAndRepairsMockData: MaintenanceWorkOrderRecord[] = [
...
export function createMaintenanceWorkOrderRecord(values: Record<string, string>, status: string) {
  return createDeliveryVehicleModuleRecord("maintenance-and-repairs", "WO", values, status);
}
