...
import type { TripTrackingEventRecord } from "@/app/src/types/modules/delivery-vehicle-management/trip-tracking/TripTrackingTypes";

export const TripTrackingMockData: TripTrackingEventRecord[] = [
...
export function createTripTrackingEventRecord(values: Record<string, string>, status: string) {
  return createDeliveryVehicleModuleRecord("trip-tracking", "EVT", values, status);
}
