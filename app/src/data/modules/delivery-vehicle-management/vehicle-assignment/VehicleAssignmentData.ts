...
import type { VehicleAssignmentRecord } from "@/app/src/types/modules/delivery-vehicle-management/vehicle-assignment/VehicleAssignmentTypes";

export const VehicleAssignmentMockData: VehicleAssignmentRecord[] = [
...
export function createVehicleAssignmentRecord(values: Record<string, string>, status: string) {
  return createDeliveryVehicleModuleRecord("vehicle-assignment", "ASN", values, status);
}
