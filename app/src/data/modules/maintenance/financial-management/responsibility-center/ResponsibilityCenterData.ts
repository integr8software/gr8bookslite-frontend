...
export function buildResponsibilityCenterTree(
...
export function flattenResponsibilityCenterTree(
	...
	return nodes.flatMap((node) => {
		...
		return [
			current,
			...flattenResponsibilityCenterTree(node.children, expandedIds, level + 1),
		];
	});
}

export function getResponsibilityCenterExpandableIds(
	centers: ResponsibilityCenter[],
) {
