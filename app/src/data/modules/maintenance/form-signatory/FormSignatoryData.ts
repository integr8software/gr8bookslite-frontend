...
import { FormSignatoryLabelOptions } from "@/app/src/constants/modules/maintenance/form-signatory/FormSignatoryConstants";
import type {
...
function collectModuleOptions(
	...
	for (const item of items) {
		if (item.module && item.key !== "maintenance-form-signatory") {
