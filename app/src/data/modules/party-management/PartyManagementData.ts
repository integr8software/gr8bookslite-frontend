...
export function createPartyInformationFormValues(
  ...
  return {
    ...
    defaultResponsibilityCenterId: record.defaultResponsibilityCenterId ?? "",
    defaultResponsibilityCenterName: record.defaultResponsibilityCenterName ?? "",
    defaultPaymentTypeId: record.defaultPaymentTypeId ?? "",
    defaultPaymentTypeName: record.defaultPaymentTypeName ?? "",
    defaultBank: record.defaultBank ?? "",
    defaultBankAccountNo: record.defaultBankAccountNo ?? "",
    tin: record.tin,
...
export function createPartySubmitPayload(values: PartyInformationFormValues) {
  ...
  return {
    ...
    defaultResponsibilityCenterId: values.defaultResponsibilityCenterId || null,
    defaultResponsibilityCenterName: values.defaultResponsibilityCenterName || null,
    defaultPaymentTypeId: values.defaultPaymentTypeId || null,
    defaultPaymentTypeName: values.defaultPaymentTypeName || null,
    defaultBank: values.defaultBank.trim() || null,
    defaultBankAccountNo: values.defaultBankAccountNo.trim() || null,
    tin: values.tin.trim(),
...
function normalizePartyRecordValues(
  ...
  return {
    ...
    termId: values.termId,
    termName: values.termName,
    defaultResponsibilityCenterId: values.defaultResponsibilityCenterId,
    defaultResponsibilityCenterName: values.defaultResponsibilityCenterName,
    defaultPaymentTypeId: values.defaultPaymentTypeId,
    defaultPaymentTypeName: values.defaultPaymentTypeName,
    defaultBank: values.defaultBank.trim(),
    defaultBankAccountNo: values.defaultBankAccountNo.trim(),
    tin: values.tin.trim(),
    atcCode: values.atcCode ? normalizeAtcCode(values.atcCode) : "",
    defaultPurchaseInputVatTaxSourceKey: values.defaultPurchaseInputVatTaxSourceKey,
    defaultPurchaseEwtTaxSourceKey: values.defaultPurchaseEwtTaxSourceKey,
