...
function normalizePurchaseRequestRecordDefaults(record: Partial<PurchaseRequestRecord>): PurchaseRequestRecord {
  ...
  return {
    ...
    forDepartment: record.forDepartment ?? record.responsibilityCenter ?? "",
    responsibilityCenterId: record.responsibilityCenterId ?? "",
    responsibilityCenter: record.responsibilityCenter ?? record.forDepartment ?? "",
