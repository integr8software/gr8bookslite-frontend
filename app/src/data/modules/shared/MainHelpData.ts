...
export const MainHelpArticles: MainHelpArticle[] = [
  ...
  article(
    ...
    "Configure inventory master files, items, units, categories, and warehouse records.",
    [
      "Inventory and Warehouse Management defines the records that inventory documents depend on, including warehouses, items, item categories, item types, and units of measurement.",
      "Good inventory setup improves item selection, stock movement tracking, valuation, and inventory reporting.",
    ],
  ...
  article(
    ...
    "Maintain warehouse locations used by inventory transactions.",
    [
      "Warehouse Management stores the locations where stock can be received, issued, transferred, counted, or valued.",
      "Assign clear warehouse codes and names so stock movement reports can identify where inventory activity occurred.",
    ],
  ...
  article(
    ...
    "Maintain item records used by sales, purchasing, and inventory documents.",
    [
      "Item Management stores item names, codes, categories, types, units, and other item details used during document entry.",
  ...
  article(
    ...
    "Organize items by category, subcategory, type, subtype, and unit.",
    [
      "Item classifications make item lists easier to search and keep reports grouped in a meaningful way.",
      "Use units of measurement consistently so receiving, issuing, sales, purchasing, and valuation documents calculate quantities correctly.",
    ],
