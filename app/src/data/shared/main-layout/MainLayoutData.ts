...
const CurrentUserRoleDetails = {
  ...
  permissions: {
    "workspace.dashboard": { view: true },
    "workspace.activity": { view: true },
    "workspace.companies": { view: true, edit: true },
    "workspace.branches": { view: true, add: true, edit: true },
    "workspace.users": { view: true, add: true, edit: true },
    "workspace.audit": { view: true },
    "workspace.billing.plans": { view: true, add: true, edit: true },
    "workspace.billing.subscriptions": { view: true },
    "workspace.billing.invoices": { view: true },
    "workspace.billing.promotions": { view: true, add: true, edit: true },
    "workspace.platform.settings": { view: true, edit: true },
    "workspace.monitoring.logs": { view: true },
    "workspace.monitoring.security": { view: true },
    "workspace.support.announcements": { view: true },
