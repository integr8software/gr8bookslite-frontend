...
const PermissionCodeByNavigationKey: Record<string, string> = {
  ...
  "reports-maintenance": "RM",
  "reports-financial": "FR",
  "reports-inventory": "IR",
  "reports-bir": "BIRR",
  "maintenance-users": "U",
      ...
      group(
        ...
        [
          ...
          moduleItem(
            ...
            "/maintenance/warehouse-management/activity-history",
            "maintenance.warehouse",
            "inventory",
          ),
        ],
