...
export const MainModuleCatalogHelperText: Record<string, string> = {
  ...
  "maintenance-disbursement-type": "Maintain disbursement classifications and their expense account setup.",
  "maintenance-collection-type": "Maintain collection classifications and their revenue account setup.",
  ...
  "maintenance-project-maintenance": "Maintain project records used across company transactions and reports.",
  "maintenance-project": "Maintain project records used across company transactions and reports.",
  ...
  "cash-disbursement-cash-advance": "Record cash advances.",
  ...
  "cash-disbursement-advances-to-suppliers": "Record supplier advances before final billing.",
  "cash-disbursement-recurring-transactions": "Manage recurring cash disbursement transactions.",
...
export const MainModuleCatalogSections: MainNavigationSection[] = [
  ...
  section("maintenance", "Maintenance", "/maintenance", "maintenance", "maintenance.chartOfAccounts", [
    ...
    moduleItem("maintenance-disbursement-type", "Disbursement Type Maintenance", "DTM", "maintenance.defaultAccount"),
    moduleItem("maintenance-collection-type", "Collection Type Maintenance", "CTM", "maintenance.defaultAccount"),
    ...
    moduleItem("maintenance-project-maintenance", "Project Maintenance", "PJM", "maintenance.project"),
  ...
  section(
    ...
    [
      ...
      moduleItem(
        "cash-disbursement-advances-to-suppliers",
