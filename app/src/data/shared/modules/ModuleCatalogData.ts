...
export const MODULE_ROUTE_MAP = {
  ...
  WS: "/warehouse-management/storage-locations",
  WSL: "/warehouse-management/storage-locations",
  WLY: "/warehouse-management/storage-layout",
  WILS: "/warehouse-management/item-location-setup",
  WCSR: "/warehouse-management/capacity-storage-rules",
  WLA: "/warehouse-management/location-availability",
  WSBW: "/warehouse-management/stock-by-warehouse",
  WSBL: "/warehouse-management/stock-by-location",
  WSMH: "/warehouse-management/stock-movement-history",
  WIA: "/warehouse-management/item-availability",
  WT: "/warehouse-management/warehouse-transfers",
  WLOCT: "/warehouse-management/location-transfer",
  WRP: "/warehouse-management/receiving-putaway",
  WPD: "/warehouse-management/picking-dispatch",
  WSC: "/warehouse-management/stock-count",
  WSA: "/warehouse-management/stock-adjustment",
  WSI: "/warehouse-management/item-availability",
