...
export function useDisbursementVoucherEntryLookups({
  ...
  return {
    ...
    isTaxCodesError: taxCodesQuery.isError || taxDefaultAccountOptionsQuery.isError,
    isTaxCodesLoading: taxCodesQuery.isLoading || taxDefaultAccountOptionsQuery.isLoading,
    partyOptions,
