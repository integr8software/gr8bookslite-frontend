...
export type RevolvingFundReplenishmentLookupValues = Pick<
...
export function useRevolvingFundReplenishmentDetailsLookups(values: RevolvingFundReplenishmentLookupValues) {
