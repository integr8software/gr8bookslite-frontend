...
export function useRevolvingFundReplenishmentOverviewPage() {
  ...
  const columns = useMemo(
    () => [
      columnHelper.accessor("transactionNo", { header: RevolvingFundReplenishmentColumnLabels.transactionNo, size: RevolvingFundReplenishmentOverviewColumnWidths.transactionNo, meta: { label: RevolvingFundReplenishmentColumnLabels.transactionNo } }),
      columnHelper.accessor("documentDate", { header: RevolvingFundReplenishmentColumnLabels.documentDate, size: RevolvingFundReplenishmentOverviewColumnWidths.documentDate, meta: { label: RevolvingFundReplenishmentColumnLabels.documentDate } }),
      columnHelper.accessor("partyCode", { header: RevolvingFundReplenishmentColumnLabels.partyCode, size: RevolvingFundReplenishmentOverviewColumnWidths.partyCode, meta: { label: RevolvingFundReplenishmentColumnLabels.partyCode } }),
      columnHelper.accessor("partyName", { header: RevolvingFundReplenishmentColumnLabels.partyName, size: RevolvingFundReplenishmentOverviewColumnWidths.partyName, meta: { label: RevolvingFundReplenishmentColumnLabels.partyName } }),
      columnHelper.accessor("accountCode", { header: RevolvingFundReplenishmentColumnLabels.accountCode, size: RevolvingFundReplenishmentOverviewColumnWidths.accountCode, meta: { label: RevolvingFundReplenishmentColumnLabels.accountCode } }),
      columnHelper.accessor("accountTitle", { header: RevolvingFundReplenishmentColumnLabels.accountTitle, size: RevolvingFundReplenishmentOverviewColumnWidths.accountTitle, meta: { label: RevolvingFundReplenishmentColumnLabels.accountTitle } }),
      columnHelper.accessor("amount", { header: RevolvingFundReplenishmentColumnLabels.amount, size: RevolvingFundReplenishmentOverviewColumnWidths.amount, meta: { label: RevolvingFundReplenishmentColumnLabels.amount } }),
      columnHelper.accessor("remarks", { header: RevolvingFundReplenishmentColumnLabels.remarks, size: RevolvingFundReplenishmentOverviewColumnWidths.remarks, meta: { label: RevolvingFundReplenishmentColumnLabels.remarks } }),
      columnHelper.accessor("createdBy", { header: RevolvingFundReplenishmentColumnLabels.createdBy, size: RevolvingFundReplenishmentOverviewColumnWidths.createdBy, meta: { label: RevolvingFundReplenishmentColumnLabels.createdBy } }),
      columnHelper.accessor("createdAt", { header: RevolvingFundReplenishmentColumnLabels.createdAt, size: RevolvingFundReplenishmentOverviewColumnWidths.createdAt, meta: { label: RevolvingFundReplenishmentColumnLabels.createdAt } }),
      columnHelper.accessor("updatedBy", { header: RevolvingFundReplenishmentColumnLabels.updatedBy, size: RevolvingFundReplenishmentOverviewColumnWidths.updatedBy, meta: { label: RevolvingFundReplenishmentColumnLabels.updatedBy } }),
      columnHelper.accessor("updatedAt", { header: RevolvingFundReplenishmentColumnLabels.updatedAt, size: RevolvingFundReplenishmentOverviewColumnWidths.updatedAt, meta: { label: RevolvingFundReplenishmentColumnLabels.updatedAt } }),
      columnHelper.accessor("status", { header: RevolvingFundReplenishmentColumnLabels.status, size: RevolvingFundReplenishmentOverviewColumnWidths.status, meta: { className: "text-center", label: RevolvingFundReplenishmentColumnLabels.status } }),
      columnHelper.display({ id: "actions", header: RevolvingFundReplenishmentColumnLabels.actions, size: RevolvingFundReplenishmentOverviewColumnWidths.actions, meta: { className: "text-center", label: RevolvingFundReplenishmentColumnLabels.actions } }),
    ],
    [],
  );
...
export type RevolvingFundReplenishmentOverviewPageState = ReturnType<
  typeof useRevolvingFundReplenishmentOverviewPage
>;
