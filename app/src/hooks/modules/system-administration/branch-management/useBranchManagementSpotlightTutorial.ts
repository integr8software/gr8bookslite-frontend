...
} from "@/app/src/data/modules/system-administration/branch-management/BranchManagementSpotlightTutorialData";
...
export function useBranchManagementSpotlightTutorial() {
  ...
  useEffect(() => {
    ...
    if (pathname !== BranchManagementHref) {
    ...
    try {
      ...
      window.localStorage.removeItem(BranchManagementSpotlightTutorialStorageKey);
      scheduleVisibilityChange(true);
    }
