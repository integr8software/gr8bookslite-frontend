...
import { createWarehouseStockByWarehouseRecords } from "@/app/src/data/modules/warehouse-management/warehouse-inventory/stock-by-warehouse/WarehouseStockByWarehouseData";
...
import {
  WarehouseStockByWarehouseQueryKeys,
  createWarehouseStockByWarehouseRecord,
  fetchWarehouseStockByWarehouse,
  updateWarehouseStockByWarehouseRecord,
} from "@/app/src/services/modules/warehouse-management/warehouse-inventory/stock-by-warehouse/WarehouseStockByWarehouseApi";
import type {
...
export function useWarehouseStockByWarehouseListPage(module: WarehouseStockByWarehouseModule) {
  const config = WarehouseStockByWarehouseConfigs[module];
  ...
  const [demoRecords, setDemoRecords] = useState(() =>
    createWarehouseStockByWarehouseRecords(module),
  );
  const workspaceQuery = useQuery({
    queryKey: WarehouseStockByWarehouseQueryKeys.list(module, activeCompanyId, warehouseFilter),
    queryFn: () =>
      fetchWarehouseStockByWarehouse(module, {
  ...
  const columns = useMemo<ColumnDef<WarehouseStockByWarehouseRecord>[]>(
    () =>
  ...
  const saveMutation = useMutation({
    mutationFn: (record: WarehouseStockByWarehouseRecord) =>
      record.id
        ? updateWarehouseStockByWarehouseRecord(module, record)
        : createWarehouseStockByWarehouseRecord(module, {
            cells: record.cells,
    ...
    onSuccess: () =>
      queryClient.invalidateQueries({
        queryKey: WarehouseStockByWarehouseQueryKeys.all(activeCompanyId),
      }),
  });
  ...
  async function saveRecord(record: WarehouseStockByWarehouseRecord) {
    if (!apiEnabled) {
      const nextRecord = {
        ...record,
