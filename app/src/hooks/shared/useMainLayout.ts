...
import {
  ...
  hasAccess,
} from "@/app/src/data/shared/MainLayout/ModuleShellUtils";
import {
...
import { ModuleHelpArticles } from "@/app/src/data/shared/ModuleHelp/ModuleHelpData";
import { getHelpArticleForPath } from "@/app/src/data/shared/ModuleHelp/ModuleHelpUtils";
...
const NavigationDropdownHelperText: Record<string, string> = {
  ...
  "maintenance-user-management": "Manage users, roles, and departments.",
