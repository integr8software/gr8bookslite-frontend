...
export const CashVoucherQueryKeys = {
  ...
  defaultAccounts: (companyId?: number | null) => [...CashVoucherQueryKeys.all, QueryLookupScope, "default-accounts", companyId] as const,
  expenseTypes: (companyId?: number | null) => [...CashVoucherQueryKeys.all, QueryLookupScope, "expense-types", companyId] as const,
};
