import { TaxMaintenanceApiPath } from "@/app/src/constants/modules/financial-maintenance/tax-maintenance/TaxMaintenanceConstants";
...
function mapApiTaxMaintenance(tax: ApiTaxMaintenance): TaxMaintenance {
  return {
    ...
    isExempted: tax.isExempted ?? false,
...
function toApiTaxMaintenancePayload(
  ...
  return {
    ...
    percentage: values.isExempted ? 0 : Number(values.percentage || 0),
    isExempted: values.isExempted,
