...
import type { useItemsListPage } from "@/app/src/hooks/modules/item-management/items/useItemsListPage";
...
export type ItemCategoryAccountingSetupStatus = "Configured" | "Inherited";

export type ItemCategoryAccountingSetupStatusFilter = "" | ItemCategoryAccountingSetupStatus;
...
export type ItemVariationAssignment = {
  id: string;
  variationId: string;
  value: string;
};
...
export type ItemRecord = {
  ...
  variationAssignments: ItemVariationAssignment[];
...
export type ItemCategoryFormValues = ItemCategoryAccountingRequirements & {
  name: string;
  parentId: string;
  description: string;
  behaviors: ItemBehavior[];
...
export type ItemFormErrors = Partial<Record<keyof ItemFormValues | "suppliers", string>>;

export type ItemCategoryFormErrors = Partial<
  Record<keyof ItemCategoryFormValues | keyof ItemCategoryAccountingSetup, string>
>;
...
export type ItemTableColumnKey =
  "code" | "skuCode" | "name" | "category" | "uom" | "costPrice" | "sellingPrice" | "status";
...
export type ItemCategoryTableProps = {
  ...
  onAccountingFilterChange: (value: ItemCategoryAccountingSetupStatusFilter) => void;
