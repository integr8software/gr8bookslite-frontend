import type { MasterPromotionDiscountKind, MasterPromotionType } from "@/app/src/types/master/promotions/MasterPromotionTypes";
import type {
...
export type WorkspaceBillingCompanyTab = "overview" | "invoices" | "payments" | "subscription";

export type WorkspaceBillingRecordStatus = "PAID" | "OPEN" | "PENDING" | "FAILED" | "CANCELED" | "REFUNDED";

export type WorkspaceBillingRecordCategory =
  "SUBSCRIPTION" | "RENEWAL" | "ADDITIONAL_COMPANY" | "ADDITIONAL_USER" | "ADD_ON" | "PAYMENT" | "REFUND";
...
export type WorkspaceBillingInvoiceRecord = {
  ...
  category: Exclude<WorkspaceBillingRecordCategory, "PAYMENT" | "REFUND">;
  companyId: string;
  currencyCode: string;
  description: string;
  id: string;
  ...
  status: WorkspaceBillingRecordStatus;
};

export type WorkspaceBillingPaymentRecord = {
  amount: number;
  billingMode: BillingMode;
  companyId: string;
  currencyCode: string;
...
export type WorkspaceBillingPromotionType = Extract<MasterPromotionType, "Coupon" | "Voucher" | "Promo Code">;

export type WorkspaceBillingPromotionApplicationMode = "Possession" | "Typed code";
...
export type WorkspaceBillingRenewalState = "Overdue" | "Due today" | "Due soon" | "Scheduled";
...
export type WorkspacePromotionCodeFormErrors = Partial<Record<keyof WorkspacePromotionCodeFormValues, string>>;
