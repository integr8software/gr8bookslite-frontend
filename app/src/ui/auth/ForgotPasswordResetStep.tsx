...
export function ForgotPasswordResetStep({ state, formAction, pending, isResetComplete, resetToken }: ForgotPasswordResetStepProps) {
    ...
    return (
      <div className="space-y-5">
        <div className="rounded-md border border-skyblue/25 bg-skyblue/10 px-4 py-3 text-sm leading-6 text-darknavy">
          ...
          <p className="mt-1 text-darknavy/75">Use your new password the next time you log in.</p>
        </div>
