...
function isManualGeneratedTaxAccountingEntry(entry: AccountsPayableVoucherAccountingEntry) {
  return (
...
function isExpenseColumnId(columnId: string): columnId is AccountsPayableVoucherExpenseColumnId {
