            ...
            <div className="grid min-w-0 gap-4">
              ...
              >
                <div className="grid min-w-0 gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
                  ...
                  />
                  <div className="grid min-w-0 gap-2 sm:grid-cols-[7.5rem_10rem] sm:items-start">
                    <label
                      htmlFor="accounts-payable-voucher-exchange-rate"
              ...
              >
                <div className="grid min-w-0 gap-3 sm:grid-cols-[minmax(0,1fr)_auto] sm:items-start">
                  ...
                  <div className="grid min-w-0 gap-2 sm:grid-cols-[7.5rem_10rem] sm:items-start">
                    <label
                      htmlFor="accounts-payable-voucher-dueDate"
                      className="whitespace-nowrap pt-2 text-sm font-semibold text-darknavy"
                    >
                      Due Date
                    </label>
                    <div className="min-w-0">
                      <input
                        id="accounts-payable-voucher-dueDate"
