...
import { useApprovalManagementListPage } from "@/app/src/hooks/modules/approval-management/useApprovalManagementListPage";
import { ModuleHeader } from "@/app/src/ui/shared/module/ModuleHeader";
import { ApprovalManagementSidepanel } from "@/app/src/ui/modules/approval-management/approval-rules/sidepanel/ApprovalManagementSidepanel";
import { ApprovalManagementEditor } from "@/app/src/ui/modules/approval-management/approval-rules/workflow-details/ApprovalManagementEditor";
    ...
    <section className="approval-management-shell grid min-h-0 gap-5">
      ...
      <div className="approval-management-list-page grid min-h-[38rem] min-w-0 items-stretch overflow-hidden rounded-lg border border-darknavy/10 bg-white shadow-sm xl:grid-cols-[minmax(22rem,0.85fr)_minmax(0,1.35fr)]">
        ...
        <ApprovalManagementEditor
          ...
          errors={page.errors}
          hasWorkflowChanges={page.hasWorkflowChanges}
          ...
          onRoutingRuleStageMove={page.moveRoutingRuleStage}
