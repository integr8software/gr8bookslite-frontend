...
import { AdvancesToSuppliersLink } from "@/app/src/constants/modules/cash-disbursement/advances-to-suppliers/AdvancesToSuppliersConstants";
...
export function AdvancesToSuppliersNotFound() {
  return (
    <section className="grid gap-4 rounded-lg border border-darknavy/10 bg-white p-5">
      ...
      <Link href={AdvancesToSuppliersLink} className={`${moduleHeaderActionClassNames.secondary} w-fit`}>
