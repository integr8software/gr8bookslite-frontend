...
export function AdvancesToSuppliersStatusActions({
  ...
  const actions = createAdvancesToSuppliersStatusActionItems({
    onRequestConfirmation,
    record,
  });
  ...
  return (
    <>
      <div className="flex items-center gap-2 lg:hidden">
        <ModuleActionMenu items={actions} label="Advances to suppliers actions" />
      </div>
...
function createAdvancesToSuppliersStatusActionItems({
  onRequestConfirmation,
  record,
}: {
  onRequestConfirmation: (action: AdvancesToSuppliersConfirmationAction) => void;
