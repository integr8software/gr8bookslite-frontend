...
} from "@/app/src/ui/modules/cash-disbursement/cash-advance-multiple-entry/entries/utils/CashAdvanceMultipleEntryEntryRowUtils";
      ...
      <ModuleDataEntry
        ...
        onMoveColumn={(fromColumnId, toColumnId) =>
          setVisibleAccountingColumnIds((current) =>
            moveCashAdvanceMultipleEntryColumnId(current, fromColumnId, toColumnId)
          )
        }
