...
import { usePettyCashFundReplenishmentCopyFromDialog } from "@/app/src/hooks/modules/cash-disbursement/petty-cash-fund-replenishment/usePettyCashFundReplenishmentCopyFromDialog";
import type {
...
interface PettyCashFundReplenishmentCopyFromDialogProps {
  isOpen: boolean;
  source: string;
  onClose: () => void;
  onSelect: (record: PettyCashFundReplenishmentCopyFromRecord) => void;
}
...
export function PettyCashFundReplenishmentCopyFromDialog({
  isOpen,
  source,
  onClose,
  onSelect,
}: PettyCashFundReplenishmentCopyFromDialogProps) {
  const dialog = usePettyCashFundReplenishmentCopyFromDialog();
