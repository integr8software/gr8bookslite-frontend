import { PettyCashFundReplenishmentEntryTabs as EntryTabs } from "@/app/src/constants/modules/cash-disbursement/petty-cash-fund-replenishment/PettyCashFundReplenishmentConstants";
import type { PettyCashFundReplenishmentEntryTab } from "@/app/src/types/modules/cash-disbursement/petty-cash-fund-replenishment/PettyCashFundReplenishmentTypes";

export function PettyCashFundReplenishmentEntryTabs({
  activeTab,
  onTabChange,
}: {
  activeTab: PettyCashFundReplenishmentEntryTab;
