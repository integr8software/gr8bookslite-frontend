...
import { PettyCashFundHref } from "@/app/src/constants/modules/cash-disbursement/petty-cash-fund/PettyCashFundConstants";
...
export function PettyCashFundNotFound() {
  return (
    <section className="grid gap-4 rounded-lg border border-darknavy/10 bg-white p-5">
      ...
      <Link href={PettyCashFundHref} className={`${moduleHeaderActionClassNames.secondary} w-fit`}>
