...
import { usePettyCashReplenishmentDetailsLookups } from "@/app/src/hooks/modules/cash-disbursement/petty-cash-replenishment/usePettyCashReplenishmentDetailsLookups";
...
export function PettyCashReplenishmentDetailsFields({
  ...
  } = usePettyCashReplenishmentDetailsLookups(page.values);
