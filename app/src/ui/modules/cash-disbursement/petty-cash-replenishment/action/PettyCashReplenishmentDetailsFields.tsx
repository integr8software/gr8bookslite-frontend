import {
  PettyCashReplenishmentAccountOptions,
  PettyCashReplenishmentPartyOptions,
  PettyCashReplenishmentProjectOptions,
        ...
        <div className="grid min-w-0 content-start gap-5">
          <TransactionField label="Party Name" error={page.errors.partyName} isRequired>
            <AppLookupDropdown
              ...
              options={PettyCashReplenishmentPartyOptions}
          ...
          <TransactionField label="Project Name">
            <AppLookupDropdown
              ...
              options={PettyCashReplenishmentProjectOptions}
              readOnly={page.isReadonly}
          ...
          <TransactionField label="Default Account Title" error={page.errors.accountTitle} isRequired>
            <AppLookupDropdown
              ...
              options={PettyCashReplenishmentAccountOptions}
              readOnly={page.isReadonly}
