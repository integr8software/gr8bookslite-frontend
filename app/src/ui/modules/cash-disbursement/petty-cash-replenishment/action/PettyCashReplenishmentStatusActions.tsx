...
export function PettyCashReplenishmentStatusActions({
  ...
  const actions = createPettyCashReplenishmentStatusActionItems({
    onRequestConfirmation,
    record,
  });
  ...
  return (
    <>
      <div className="flex items-center gap-2 lg:hidden">
        <ModuleActionMenu items={actions} label="Petty cash replenishment actions" />
      </div>
...
function createPettyCashReplenishmentStatusActionItems({
  onRequestConfirmation,
  record,
}: {
  onRequestConfirmation: (action: PettyCashReplenishmentConfirmationAction) => void;
