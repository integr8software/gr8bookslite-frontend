...
export function PettyCashReplenishmentReportPreview({
  isOpen,
  onClose,
  onGeneratePdf,
  page,
  ...
  return (
    <ReportPreviewDrawer
      ...
      title="Petty Cash Replenishment Preview"
    ...
    >
      <article className="mx-auto min-w-[82rem] max-w-7xl bg-white p-12 text-darknavy shadow-sm">
        <div className="text-center">
          ...
          <h1 className="mt-2 text-2xl font-bold">Petty Cash Replenishment</h1>
