...
const tableCellClassName = "px-4 py-4 align-middle text-sm text-darknavy";
...
function renderPettyCashVoucherCell(
	...
	if (columnId === "voucherNo") {
		return (
			<span className={joinClasses("font-semibold", moduleAccentClassNames.iconText)}>
				{row.voucherNo}
			</span>
		);
	}
