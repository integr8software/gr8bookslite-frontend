import { RevolvingFundReplenishmentEntryTabs as EntryTabs } from "@/app/src/constants/modules/cash-disbursement/revolving-fund-replenishment/RevolvingFundReplenishmentConstants";
import type { RevolvingFundReplenishmentEntryTab } from "@/app/src/types/modules/cash-disbursement/revolving-fund-replenishment/RevolvingFundReplenishmentTypes";

export function RevolvingFundReplenishmentEntryTabs({
  activeTab,
  onTabChange,
}: {
  activeTab: RevolvingFundReplenishmentEntryTab;
