    ...
    >
      <div className="grid min-w-0 grid-cols-1 gap-2 sm:grid-cols-2 2xl:grid-cols-[minmax(18rem,2fr)_minmax(14rem,1fr)_minmax(14rem,1fr)]">
        <div className="sm:col-span-2 2xl:col-span-1">
          <ModuleTableSearch
            label="Search revolving fund replenishments"
            value={page.query}
            onChange={page.setQuery}
            placeholder="Search by Replenishment No., Party Name, Account Title, or Remarks"
          />
        </div>
      ...
      >
        <ModuleTableFilterSelect
          ...
          options={RevolvingFundReplenishmentStatusOptions.map((status) => ({ label: status, value: status }))}
