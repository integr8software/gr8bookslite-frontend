...
export function RevolvingFundStatusActions({
  ...
  const actions = createRevolvingFundStatusActionItems({
    onRequestConfirmation,
    record,
  });
  ...
  return (
    <>
      <div className="flex items-center gap-2 lg:hidden">
        <ModuleActionMenu items={actions} label="Revolving fund actions" />
      </div>
...
function createRevolvingFundStatusActionItems({
  onRequestConfirmation,
  record,
}: {
  onRequestConfirmation: (action: RevolvingFundConfirmationAction) => void;
