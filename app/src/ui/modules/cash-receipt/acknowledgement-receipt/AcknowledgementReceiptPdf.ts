		...
		table: {
			...
			body: [
				...
				[
					...
					leftBodyCell(formatAcknowledgementReceiptAmount(receiptAmount), "right"),
				],
				[
					{
				...
				[
					...
					leftBodyCell(formatAcknowledgementReceiptAmount(cashAmount), "right"),
				],
				[
					leftHeaderCell("[ ]  CHECK PAYMENT"),
					leftBodyCell(formatAcknowledgementReceiptAmount(checkAmount), "right"),
				],
		...
		stack: [
			...
			receiptLine("the amount of", formatAmountInWords(receiptAmount)),
			{
				columns: [
					...
					{ text: "( P", width: 18 },
					underlineText(
						formatAcknowledgementReceiptAmount(receiptAmount),
						110,
						"center",
					),
					{ text: ")", width: 10 },
	...
	const populatedRows = values.lineEntries
		...
		.map((entry, index) => ({
			...
			amount:
				index === 0
					? formatAcknowledgementReceiptAmount(receiptAmount)
					: formatAcknowledgementReceiptAmount(0),
		}));
