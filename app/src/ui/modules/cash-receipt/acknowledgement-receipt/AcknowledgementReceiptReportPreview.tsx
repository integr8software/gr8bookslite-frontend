...
function AcknowledgementReceiptReportDocument({
	values,
}: {
	values: AcknowledgementReceiptFormValues;
}) {
			...
			<div className="grid grid-cols-[17rem_1fr] gap-3">
				<table className="h-fit w-full table-fixed border-collapse text-[10px]">
					<tbody>
						...
						<tr>
							...
							<ReceiptCell className="text-right">
								{formatAcknowledgementReceiptAmount(cashAmount)}
							</ReceiptCell>
						</tr>
						<tr>
							<ReceiptCell className="font-bold">
							...
							<ReceiptCell className="text-right">
								{formatAcknowledgementReceiptAmount(checkAmount)}
							</ReceiptCell>
						</tr>
				...
				<section className="min-h-[30rem]">
					...
					<div className="mt-1 grid grid-cols-[1fr_auto] items-end gap-4">
						<h2 className="text-base font-bold">ACKNOWLEDGEMENT RECEIPT</h2>
