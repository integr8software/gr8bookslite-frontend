...
import { DeliveryTripsAndDispatchTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/delivery-trips-and-dispatch/DeliveryTripsAndDispatchConstants";
import { useDeliveryTripsAndDispatchListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/delivery-trips-and-dispatch/useDeliveryTripsAndDispatchListPage";
import { ModuleHeader } from "@/app/src/ui/shared/module/ModuleHeader";
import { ModuleStatusBadge } from "@/app/src/ui/shared/module/ModuleStatusBadge";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { getColumnMetaClassName } from "@/app/src/ui/shared/module/module-table/utils";

export function DeliveryTripsAndDispatchListPage() {
  const page = useDeliveryTripsAndDispatchListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={DeliveryTripsAndDispatchTablePaginationStorageKey}
        table={page.table}
