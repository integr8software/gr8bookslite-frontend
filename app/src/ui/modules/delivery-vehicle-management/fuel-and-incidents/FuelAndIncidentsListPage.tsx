...
import { FuelAndIncidentsTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/fuel-and-incidents/FuelAndIncidentsConstants";
import { useFuelAndIncidentsListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/fuel-and-incidents/useFuelAndIncidentsListPage";
import { ModuleHeader } from "@/app/src/ui/shared/module/ModuleHeader";
import { ModuleStatusBadge } from "@/app/src/ui/shared/module/ModuleStatusBadge";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { getColumnMetaClassName } from "@/app/src/ui/shared/module/module-table/utils";

export function FuelAndIncidentsListPage() {
  const page = useFuelAndIncidentsListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={FuelAndIncidentsTablePaginationStorageKey}
        table={page.table}
