...
import { LoadPlanningTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/load-planning/LoadPlanningConstants";
import { useLoadPlanningListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/load-planning/useLoadPlanningListPage";
import { ModuleHeader } from "@/app/src/ui/shared/module/ModuleHeader";
import { ModuleStatusBadge } from "@/app/src/ui/shared/module/ModuleStatusBadge";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { getColumnMetaClassName } from "@/app/src/ui/shared/module/module-table/utils";

export function LoadPlanningListPage() {
  const page = useLoadPlanningListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={LoadPlanningTablePaginationStorageKey}
        table={page.table}
