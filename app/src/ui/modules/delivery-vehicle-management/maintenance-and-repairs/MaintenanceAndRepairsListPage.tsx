...
import { MaintenanceAndRepairsTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/maintenance-and-repairs/MaintenanceAndRepairsConstants";
import { useMaintenanceAndRepairsListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/maintenance-and-repairs/useMaintenanceAndRepairsListPage";
import { ModuleHeader } from "@/app/src/ui/shared/module/ModuleHeader";
import { ModuleStatusBadge } from "@/app/src/ui/shared/module/ModuleStatusBadge";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { getColumnMetaClassName } from "@/app/src/ui/shared/module/module-table/utils";

export function MaintenanceAndRepairsListPage() {
  const page = useMaintenanceAndRepairsListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={MaintenanceAndRepairsTablePaginationStorageKey}
        table={page.table}
