...
import { VehicleAssignmentTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/vehicle-assignment/VehicleAssignmentConstants";
import { useVehicleAssignmentListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/vehicle-assignment/useVehicleAssignmentListPage";
...
export function VehicleAssignmentListPage() {
  const page = useVehicleAssignmentListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={VehicleAssignmentTablePaginationStorageKey}
        table={page.table}
