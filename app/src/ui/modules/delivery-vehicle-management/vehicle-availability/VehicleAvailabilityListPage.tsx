...
import { VehicleAvailabilityTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/vehicle-availability/VehicleAvailabilityConstants";
import { useVehicleAvailabilityListPage } from "@/app/src/hooks/modules/delivery-vehicle-management/vehicle-availability/useVehicleAvailabilityListPage";
...
export function VehicleAvailabilityListPage() {
  const page = useVehicleAvailabilityListPage();
  ...
  return (
    <section className="grid gap-5">
      ...
      <ModuleTable
        ...
        paginationStorageKey={VehicleAvailabilityTablePaginationStorageKey}
        table={page.table}
