...
import { VehicleRepairMaintenanceConfig, VehicleRepairMaintenanceTablePaginationStorageKey } from "@/app/src/constants/modules/delivery-vehicle-management/vehicle-repair-maintenance/VehicleRepairMaintenanceConstants";
...
export function VehicleRepairMaintenanceListPage() {
  return <DeliveryVehicleModuleListPage pageConfig={VehicleRepairMaintenanceConfig} paginationKey={VehicleRepairMaintenanceTablePaginationStorageKey} createRecord={createVehicleRepairMaintenanceRecord} initialRecords={VehicleRepairMaintenanceMockData} validateRecord={validateVehicleRepairMaintenance} />;
}
