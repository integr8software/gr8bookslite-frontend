...
import {
  ...
  VehicleTypesMockData,
} from "@/app/src/data/modules/delivery-vehicle-management/vehicle-types/VehicleTypesData";
...
export function VehicleTypesListPage() {
  return (
    <DeliveryVehicleModuleListPage
      pageConfig={VehicleTypesConfig}
      paginationKey={VehicleTypesTablePaginationStorageKey}
