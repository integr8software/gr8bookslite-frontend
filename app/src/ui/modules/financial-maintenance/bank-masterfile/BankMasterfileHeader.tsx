...
import type { BankMasterfilePermissions } from "@/app/src/types/modules/financial-maintenance/bank-masterfile/BankMasterfileTypes";
      ...
      actions={
        <>
          {permissions.canImport ? (
            <button type="button" onClick={onImport} className={`${moduleHeaderActionClassNames.secondary} order-2 lg:order-1`}>
