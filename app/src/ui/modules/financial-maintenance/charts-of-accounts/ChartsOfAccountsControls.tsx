...
export function Card({ children, className, ...props }: ComponentProps<"div">) {
  return (
    <div className={joinClasses("rounded-lg border border-darknavy/10 bg-white shadow-sm shadow-darknavy/5", className)} {...props}>
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={joinClasses(
        ...
        variant === "ghost" && "text-darknavy/60 hover:bg-skyblue/10 hover:text-darknavy focus-visible:ring-skyblue/15",
        variant === "danger" && "text-red-600 hover:bg-red-50 focus-visible:ring-red-500/15",
        className,
      )}
      {...props}
    >
...
export const Select = forwardRef<HTMLSelectElement, ComponentProps<"select">>(function Select({ children, className, ...props }, ref) {
  return (
    <div className="relative">
      <select
        ...
        className={joinClasses(
          ...
          props.disabled && "border-darknavy/15 opacity-100",
          className,
        )}
        {...props}
      >
