...
import { DefaultAccountImportDialog } from "@/app/src/ui/modules/financial-maintenance/default-account/DefaultAccountImportDialog";
...
export function DefaultAccountListPage() {
  ...
  return (
    <section className="grid gap-5">
      ...
      />
      <DefaultAccountStatisticCards statistics={page.statistics} isLoading={page.isLoading} />
      <DefaultAccountTable
      ...
      {page.permissions.canImport ? (
        <DefaultAccountImportDialog
          existingDefaultAccounts={page.defaultAccounts}
          isOpen={isImportOpen}
          onClose={() => setIsImportOpen(false)}
          onImportDefaultAccounts={page.addDefaultAccounts}
        />
      ) : null}
      <AppDialog
