...
import { useDiscountMaintenanceImportDialog } from "@/app/src/hooks/modules/financial-maintenance/discount-maintenance/useDiscountMaintenanceImportDialog";
import type { DiscountMaintenanceImportDialogProps } from "@/app/src/types/modules/financial-maintenance/discount-maintenance/DiscountMaintenanceTypes";
...
import { DiscountMaintenanceImportPreviewTableRow } from "@/app/src/ui/modules/financial-maintenance/discount-maintenance/DiscountMaintenanceImportPreviewTableRow";

export function DiscountMaintenanceImportDialog({
  existingDiscounts,
  isOpen,
  onClose,
  onImportDiscounts,
}: DiscountMaintenanceImportDialogProps) {
  const importDialog = useDiscountMaintenanceImportDialog({
    existingDiscounts,
    onClose,
    onImportDiscounts,
  });
  ...
  return (
    <ModuleImportDialog
      ...
      titleId="discount-maintenance-import-title"
              ...
              <tbody className="divide-y divide-darknavy/8 bg-white">
                {importDialog.visibleRows.length > 0 ? (
                  importDialog.visibleRows.map((row) => (
                    <DiscountMaintenanceImportPreviewTableRow
                      key={row.id}
                      row={row}
