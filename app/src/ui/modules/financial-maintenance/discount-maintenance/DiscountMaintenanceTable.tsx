...
import type { DiscountMaintenanceTableProps } from "@/app/src/types/modules/financial-maintenance/discount-maintenance/DiscountMaintenanceTypes";
...
export function DiscountMaintenanceTable({
  ...
  const exportFilteredRows = filteredDiscounts.map(createDiscountMaintenanceTableRecord);
  const tableMinWidthClassName = getDiscountMaintenanceTableMinWidthClassName(table.getVisibleLeafColumns().length);
