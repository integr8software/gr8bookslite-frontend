...
import { useDiscountManagementImportDialog } from "@/app/src/hooks/modules/financial-maintenance/discount-management/useDiscountManagementImportDialog";
import type { DiscountManagementImportDialogProps } from "@/app/src/types/modules/financial-maintenance/discount-management/DiscountManagementTypes";
...
import { DiscountManagementImportPreviewTableRow } from "@/app/src/ui/modules/financial-maintenance/discount-management/DiscountManagementImportPreviewTableRow";

export function DiscountManagementImportDialog({
	existingDiscounts,
	isOpen,
	onClose,
	onImportDiscounts,
}: DiscountManagementImportDialogProps) {
	const importDialog = useDiscountManagementImportDialog({
		existingDiscounts,
		onClose,
		onImportDiscounts,
	});
