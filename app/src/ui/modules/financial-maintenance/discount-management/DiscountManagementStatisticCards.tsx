...
import type { DiscountManagementStatisticCardsProps } from "@/app/src/types/modules/financial-maintenance/discount-management/DiscountManagementTypes";
import {
	ModuleStatisticCards,
	type ModuleStatisticCardItem,
} from "@/app/src/ui/shared/module/ModuleStatisticCards";

export function DiscountManagementStatisticCards({
	isLoading,
	statistics,
}: DiscountManagementStatisticCardsProps) {
