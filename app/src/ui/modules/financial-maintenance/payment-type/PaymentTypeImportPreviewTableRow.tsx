import { PaymentTypeClassificationOptions } from "@/app/src/constants/modules/financial-maintenance/payment-type/PaymentTypeConstants";
import type {
...
import { paymentTypeImportRowHasErrors } from "@/app/src/data/modules/financial-maintenance/payment-type/PaymentTypeData";
import {
...
export function PaymentTypeImportPreviewTableRow({
  ...
  isSelected: boolean;
  onPasteCell: (rowId: string, field: PaymentTypeImportColumnId, text: string) => void;
  ...
  onUpdateCell: (rowId: string, field: PaymentTypeImportColumnId, value: string) => void;
