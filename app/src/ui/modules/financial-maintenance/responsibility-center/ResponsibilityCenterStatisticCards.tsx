...
import { Building2, CheckCircle2, CirclePause, FolderKanban, Layers3, Network } from "lucide-react";
import type { ResponsibilityCenterStatisticCardsProps } from "@/app/src/types/modules/financial-maintenance/responsibility-center/ResponsibilityCenterTypes";
import { ModuleStatisticCards, type ModuleStatisticCardItem } from "@/app/src/ui/shared/module/ModuleStatisticCards";

export function ResponsibilityCenterStatisticCards({ isLoading, statistics }: ResponsibilityCenterStatisticCardsProps) {
