...
import {
  getTaxMaintenanceErrorTab,
  TaxMaintenanceFields,
} from "@/app/src/ui/modules/financial-maintenance/tax-maintenance/TaxMaintenanceFields";
import {
  type TaxMaintenanceFormErrors,
  validateTaxMaintenanceForm,
} from "@/app/src/validations/modules/financial-maintenance/tax-maintenance/TaxMaintenanceValidation";
...
export function TaxMaintenanceDrawer({
  ...
  function validateBeforeSubmit() {
    ...
    if (Object.keys(nextErrors).length > 0) {
      ...
      setActiveTab(getTaxMaintenanceErrorTab(nextErrors) ?? "tax");
      return false;
    }
    ...
    >
      ...
      >
        <TaxMaintenanceFields
          ...
          onExemptedChange={(isExempted) => {
            setValues((current) => ({
              ...current,
              isExempted,
              percentage: isExempted ? "" : current.percentage,
            }));
...
function toFormValues(tax: TaxMaintenance): TaxMaintenanceFormValues {
  return {
    ...
    percentage: tax.isExempted ? "" : tax.percentage,
