        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          >
            <input
              ...
              disabled={isReadonly || values.isExempted}
              onChange={onInputChange}
              readOnly={isReadonly}
              placeholder={values.isExempted ? "No tax" : "0"}
              className={TaxMaintenanceFieldClassName}
            />
          </Field>
          <Field label="Tax Exempt">
            <AppSwitch
              ...
              value={values.isExempted ? "exempt" : "taxable"}
              onChange={(value) => onExemptedChange(value === "exempt")}
              readOnly={isReadonly}
...
export function getTaxMaintenanceErrorTab(
