...
import type { TermsMaintenanceStatisticCardsProps } from "@/app/src/types/modules/financial-maintenance/terms-maintenance/TermsMaintenanceTypes";
import { ModuleStatisticCards, type ModuleStatisticCardItem } from "@/app/src/ui/shared/module/ModuleStatisticCards";

export function TermsMaintenanceStatisticCards({ isLoading, statistics }: TermsMaintenanceStatisticCardsProps) {
