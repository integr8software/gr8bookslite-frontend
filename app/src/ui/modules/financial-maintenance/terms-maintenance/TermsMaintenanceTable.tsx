...
import type { TermsMaintenanceTableProps } from "@/app/src/types/modules/financial-maintenance/terms-maintenance/TermsMaintenanceTypes";
...
export function TermsMaintenanceTable({
  ...
  const tableMinWidthClassName = getTermsMaintenanceTableMinWidthClassName(table.getVisibleLeafColumns().length);
