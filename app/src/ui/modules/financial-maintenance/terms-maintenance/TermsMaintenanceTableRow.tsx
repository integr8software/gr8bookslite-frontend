...
export function TermsMaintenanceTableRow({ row, permissions, onEditTerm, onToggleStatus, onViewTerm }: TermsMaintenanceTableRowProps) {
  return (
    <tr className="module-table-row">
      {row.getVisibleCells().map((cell) => (
        <TermsMaintenanceTableCell key={cell.id} className={getColumnMetaClassName(cell.column.columnDef.meta)}>
