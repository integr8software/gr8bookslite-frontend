...
type CreditMemoStatisticCardsProps = {
  isLoading: boolean;
  onStatusFilterChange: (status: CreditMemoStatusFilter) => void;
  statistics: CreditMemoStatistics;
  statusFilter: CreditMemoStatusFilter;
};

export function CreditMemoStatisticCards({
  isLoading,
  onStatusFilterChange,
  statistics,
  statusFilter,
}: CreditMemoStatisticCardsProps) {
