...
} from "@/app/src/ui/modules/inventory/delivery-receipt/action/DeliveryReceiptContent";
import { DeliveryReceiptFormHeader } from "@/app/src/ui/modules/inventory/delivery-receipt/action/DeliveryReceiptPageHeader";
...
export function DeliveryReceiptActionPage() {
  ...
  const [activeTab, setActiveTab] = useState<DeliveryReceiptDetailsSection>("customer");
  ...
  return (
    <>
      <section className="grid gap-5">
        ...
        />
        <ModuleTabs activeTab={activeTab} ariaLabel="Delivery receipt sections" tabs={DeliveryReceiptTabs} onTabChange={setActiveTab} />
        <DeliveryReceiptDetailsForm
