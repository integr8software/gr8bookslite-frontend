...
import { useMaterialRequestListPage } from "@/app/src/hooks/modules/inventory/material-request/useMaterialRequestListPage";
...
import { MaterialRequestMetrics } from "@/app/src/ui/modules/inventory/material-request/overview/MaterialRequestMetrics";
import { MaterialRequestTableRow } from "@/app/src/ui/modules/inventory/material-request/overview/MaterialRequestTableRow";

export function MaterialRequestListPage() {
	const page = useMaterialRequestListPage();
