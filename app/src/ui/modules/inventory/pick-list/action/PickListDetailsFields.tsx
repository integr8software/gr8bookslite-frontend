...
export function PickListDetailsFields({ isReadonly, onUpdateField, values }: PickListDetailsFieldsProps) {
  return (
    <div className="grid min-w-0 gap-5 xl:grid-cols-3">
      ...
      {/* Remarks spans the Driver Name and Plate No rows */}
      <div className="min-w-0 xl:row-span-2 xl:[&>*]:h-full">
        <FieldShell controlId="pick-list-remarks" label="Remarks">
          <AppLimitedTextarea
            ...
            className={`${FieldClassName} min-h-24 resize-none py-3 xl:h-full xl:min-h-0`}
