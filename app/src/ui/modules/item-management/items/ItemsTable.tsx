...
import type { ItemsTableProps } from "@/app/src/types/modules/item-management/items/ItemManagementTypes";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { ItemsTableRow } from "@/app/src/ui/modules/item-management/items/ItemsTableRow";
  ...
  return (
    <ModuleTable
      ...
      renderRow={({ id, original }) => (
        <ItemsTableRow key={id} item={original} onStatusChange={setPendingStatusItem} />
      )}
    />
  );
}
