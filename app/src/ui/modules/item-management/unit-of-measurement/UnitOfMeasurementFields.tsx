...
import type { UnitOfMeasurementFieldsProps } from "@/app/src/types/modules/item-management/unit-of-measurement/UnitOfMeasurementTypes";
...
export function UnitOfMeasurementFields({ errors, isReadonly, values, onInputChange, onStatusChange }: UnitOfMeasurementFieldsProps) {
  return (
    <div className="grid gap-4 lg:grid-cols-2">
      <FormField label="Unit of Measurement" error={errors.name} className="lg:col-span-2" required>
        <input
          name="name"
          value={values.name}
          readOnly={isReadonly}
