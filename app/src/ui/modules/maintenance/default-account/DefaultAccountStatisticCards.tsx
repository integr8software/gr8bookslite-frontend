...
import type { DefaultAccountStatisticCardsProps } from "@/app/src/types/modules/maintenance/default-account/DefaultAccountTypes";
import {
	ModuleStatisticCards,
	type ModuleStatisticCardItem,
} from "@/app/src/ui/shared/module/ModuleStatisticCards";

export function DefaultAccountStatisticCards({
	isLoading,
	statistics,
}: DefaultAccountStatisticCardsProps) {
