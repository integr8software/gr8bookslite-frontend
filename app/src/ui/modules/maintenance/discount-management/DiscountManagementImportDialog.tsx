...
import {
	...
	DiscountImportPreviewEmptyMessage,
...
import { DiscountManagementImportPreviewTableRow } from "@/app/src/ui/modules/maintenance/discount-management/DiscountManagementImportPreviewTableRow";
			...
			actions={
				<div className="grid gap-3 lg:grid-cols-[minmax(18rem,1fr)_auto]">
					...
					<div className="grid grid-cols-2 gap-2 lg:flex lg:items-start lg:justify-end">
						<button
							type="button"
							onClick={() => void downloadDiscountImportTemplate()}
							disabled={Boolean(importDialog.progress)}
						...
						>
							...
							<tbody className="divide-y divide-darknavy/8 bg-white">
								{importDialog.visibleRows.length > 0 ? (
									...
									<tr>
										<td
											colSpan={DiscountImportPreviewColumnCount}
