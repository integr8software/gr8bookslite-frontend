...
import { usePaymentTypeListPage } from "@/app/src/hooks/modules/maintenance/financial-management/payment-type/usePaymentTypeListPage";
...
import { PaymentTypeDrawer } from "@/app/src/ui/modules/maintenance/financial-management/payment-type/PaymentTypeDrawer";
import { PaymentTypeFilters } from "@/app/src/ui/modules/maintenance/financial-management/payment-type/PaymentTypeFilters";
import { PaymentTypeHeaderActions } from "@/app/src/ui/modules/maintenance/financial-management/payment-type/PaymentTypeHeaderActions";
import { PaymentTypeTable } from "@/app/src/ui/modules/maintenance/financial-management/payment-type/PaymentTypeTable";
	...
	return (
		<section className="grid gap-5">
			<ModuleHeader
				...
				titleAs="h1"
				title="Payment Type"
				description="Maintain payment type names, classifications, and active status for cash disbursement workflows."
				eyebrow={
					<>
