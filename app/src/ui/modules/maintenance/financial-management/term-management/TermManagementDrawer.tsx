...
function TermManagementDrawerPanel({ isOpen, mode, onClose, term }: { isOpen: boolean; mode: TermManagementActionMode; onClose: () => void; term?: TermManagement }) {
	...
	return <MaintenanceFormDrawer description={copy.description} eyebrow={TermManagementTitle} formId={formId} isOpen={isOpen} isReadonly={page.isReadonly} isSaving={page.isMutating} onClose={onClose} title={copy.title}>
