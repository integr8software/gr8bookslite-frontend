        ...
        <ModuleHeader
          ...
          actions={
            <TransactionTypeActionButtons
              ...
              onDeleteTransactionType={() => page.setIsDeleteDialogOpen(true)}
            />
          }
        />
  ...
  return (
    <>
      ...
      {transactionType ? (
        <button
          type="button"
          onClick={onDeleteTransactionType}
  ...
  return (
    <div className="rounded-lg border border-darknavy/10 bg-white p-5 shadow-sm">
      ...
      <p className="mt-2 text-sm text-darknavy/65">
        The requested transaction type record does not exist or has already been
        removed.
      </p>
    </div>
  );
