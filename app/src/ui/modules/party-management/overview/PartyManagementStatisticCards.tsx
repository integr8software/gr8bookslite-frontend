...
import type { PartyManagementStatisticCardsProps } from "@/app/src/types/modules/party-management/PartyManagementTypes";
import {
...
export function PartyManagementStatisticCards({
  ...
  return (
    <ModuleStatisticCards items={statisticCards} className="2xl:grid-cols-6" />
  );
}
