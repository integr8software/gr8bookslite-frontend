...
import { PartyInformationTableFilters } from "@/app/src/ui/modules/party-management/overview/table/PartyInformationTableFilters";
import { PartyInformationTableRow } from "@/app/src/ui/modules/party-management/overview/table/PartyInformationTableRow";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { Search } from "lucide-react";

export function PartyInformationTable({ isLoading, isRefreshing, lastSyncedAt, records, onRefresh }: PartyInformationTableProps) {
  ...
  return (
    <div className="overflow-hidden rounded-lg border border-darknavy/10 bg-white shadow-sm">
      <ModuleTable
        ...
        renderRow={(row) => <PartyInformationTableRow key={row.id} row={row} />}
      />
    </div>
  );
}
