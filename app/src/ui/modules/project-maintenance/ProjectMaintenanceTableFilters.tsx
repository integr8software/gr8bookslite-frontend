import {
  ProjectMaintenanceExportColumns,
...
import type {
  ...
  ProjectMaintenanceTableFiltersProps,
...
export function ProjectMaintenanceTableFilters({
  exportAllRows,
  exportFilteredRows,
  hasActiveFilters,
  isRefreshing,
  ...
  return (
    <ModuleTableToolbar
      ...
      data-spotlight-id="project-maintenance-filters"
    >
      <div
      ...
      >
        ...
        <ModuleTableFilterSelect
          ...
          options={[
            { label: "All", value: "" },
            ...ProjectMaintenanceStatusOptions.map((status) => ({
              label: status,
              value: status,
            })),
          ]}
          onChange={(value) => onStatusFilterChange(value as ProjectMaintenanceStatusFilter)}
        />
        <div
        ...
        >
          ...
          {permissions.canExport ? (
            <ModuleTableExportButton
              ...
              columns={ProjectMaintenanceExportColumns}
              fileName="project-maintenance"
