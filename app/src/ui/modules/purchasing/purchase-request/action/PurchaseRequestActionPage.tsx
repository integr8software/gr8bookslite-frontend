...
import { PurchaseRequestDetailsForm } from "@/app/src/ui/modules/purchasing/purchase-request/action/PurchaseRequestDetailsForm";
...
function PurchaseRequestActionPageInner() {
  ...
  const title = getPurchaseRequestTitle(page.mode, page.existingRequest?.transNo);
...
function PurchaseRequestHeaderActions({ page }: { page: PurchaseRequestFormPageState }) {
  return (
    <>
