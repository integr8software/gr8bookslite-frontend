...
export function PurchaseRequestDetailsForm({ isReadonly, onUpdateField, values }: PurchaseRequestDetailsFormProps) {
  return (
    <section className="min-w-0 rounded-lg border border-darknavy/10 bg-white p-4 shadow-sm shadow-darknavy/5 sm:p-5">
      <PurchaseRequestSupplierFields isReadonly={isReadonly} values={values} onUpdateField={onUpdateField} />
    </section>
  );
}
