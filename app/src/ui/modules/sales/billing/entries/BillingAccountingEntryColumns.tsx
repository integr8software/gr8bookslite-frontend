import {
	...
	BillingTaxTypeOptions,
	BillingVatTypeOptions,
...
export const BillingAccountingProtectedColumnIds =
	new Set<BillingAccountingColumnId>([
		"accountTitle",
		DebitColumnId,
		CreditColumnId,
	]);

const BillingAccountingColumnLabels: Record<
	BillingAccountingColumnId,
	string
> = {
...
const BillingAccountingColumnWidths: Record<
	BillingAccountingColumnId,
	number
> = {
	accountCode: 160,
...
type BillingAccountingEntryUpdater = (
	rowId: string,
		...
		return (
			<AppAdvancedDropdown
				...
				onChange={(value) => {
					...
					const selectedParty = BillingPartyOptions.find(
