import type { BillingEntryTab } from "@/app/src/types/modules/sales/billing/BillingTypes";
import { joinClasses } from "@/app/src/ui/shared/module/module-table/utils";

type BillingEntryTabsProps = {
  activeTab: BillingEntryTab;
  onTabChange: (tab: BillingEntryTab) => void;
};

export function BillingEntryTabs({ activeTab, onTabChange }: BillingEntryTabsProps) {
  return (
    <div
      role="tablist"
      aria-label="Billing row entry sections"
      className="inline-flex items-center gap-1 rounded-lg border border-darknavy/10 bg-offwhite/70 p-1"
    >
      {BillingEntryTabsList.map((tab) => {
...
const BillingEntryTabsList = [
  { id: "service", label: "Billing Details" },
