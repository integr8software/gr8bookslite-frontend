...
export function SalesQuotationPartyFields({ isReadonly, onUpdateField, values }: SalesQuotationPartyFieldsProps) {
    ...
    <div className="grid min-w-0 gap-5 xl:grid-cols-2 2xl:grid-cols-3">
      ...
      <div className="grid content-start gap-4">
        ...
        <SalesQuotationSelectField
          ...
          onChange={(value) => onUpdateField("status", value as SalesQuotationStatus)}
        />
      </div>
    </div>
  );
