...
export function ApprovalManagementEditor({
	...
	return (
		<form
			onSubmit={onSubmit}
			className="grid content-start gap-4 bg-offwhite/25 p-4 lg:p-5"
		>
				...
				<div className="flex min-w-0 items-center gap-4">
					<div className="min-w-0">
						...
						<div className="mt-2 flex flex-wrap items-center gap-2 text-xs font-semibold">
							<span className="text-darknavy/65">Code:</span>
							<span className="rounded-md border border-skyblue/15 bg-skyblue/10 px-2.5 py-1 font-mono text-skyblue">
								{selectedWorkflow.moduleCode}
							</span>
							<span className="rounded-md border border-darknavy/8 bg-white px-2.5 py-1 text-darknavy/70">
								{values.stageCount} approval level
								{values.stageCount === 1 ? "" : "s"}
							</span>
							{hasAmountCondition ? (
								<span className="inline-flex items-center gap-1.5 rounded-md border border-emerald-500/20 bg-emerald-50 px-2.5 py-1 text-emerald-700">
									<BadgeCheck
								...
								<span className="inline-flex items-center gap-1.5 rounded-md border border-darknavy/8 bg-white px-2.5 py-1 text-darknavy/60">
									<ListChecks
										className="h-3.5 w-3.5"
										aria-hidden="true"
									/>
