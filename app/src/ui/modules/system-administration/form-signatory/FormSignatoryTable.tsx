...
import { FormSignatoryPaginationStorageKey } from "@/app/src/constants/modules/system-administration/form-signatory/FormSignatoryConstants";
import type { useFormSignatoryMaintenancePage } from "@/app/src/hooks/modules/system-administration/form-signatory/useFormSignatoryMaintenancePage";
import { ModuleTable } from "@/app/src/ui/shared/module/module-table/ModuleTable";
import { FormSignatoryTableRow } from "@/app/src/ui/modules/system-administration/form-signatory/FormSignatoryTableRow";
import { FormSignatoryToolbar } from "@/app/src/ui/modules/system-administration/form-signatory/FormSignatoryToolbar";
				...
				<FormSignatoryTableRow
					...
					editHref={
						row.original.setupId
							? `/system-administration/form-signatory/edit/${row.original.setupId}?rowId=${encodeURIComponent(row.original.id)}`
							: currentSetupId
								? `/system-administration/form-signatory/edit/${currentSetupId}?rowId=${encodeURIComponent(row.original.id)}`
								: "/system-administration/form-signatory/add"
					}
