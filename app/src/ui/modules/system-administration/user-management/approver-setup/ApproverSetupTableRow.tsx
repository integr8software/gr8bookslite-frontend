...
import { formatApproverListLabel, formatApproverSetupDate } from "./utils";
...
export function ApproverSetupTableRow({
	...
	const isTemporary = record.assignmentType === "Temporary";
		...
		<tr className="module-table-row">
			...
			<td className="px-4 py-4 align-center">
				{isTemporary ? (
					...
					<div className="text-sm font-medium text-darknavy/45">
						Not time-bound
					</div>
				)}
			</td>
