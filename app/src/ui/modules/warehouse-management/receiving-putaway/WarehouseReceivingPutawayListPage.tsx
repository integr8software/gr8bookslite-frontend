...
import {
  ...
  WarehouseReceivingPutawayPaginationStorageKey,
} from "@/app/src/constants/modules/warehouse-management/receiving-putaway/WarehouseReceivingPutawayConstants";
import { useWarehouseReceivingPutawayListPage } from "@/app/src/hooks/modules/warehouse-management/receiving-putaway/useWarehouseReceivingPutawayListPage";
import type {
...
import { validateWarehouseReceivingPutawayDraft } from "@/app/src/validations/modules/warehouse-management/receiving-putaway/WarehouseReceivingPutawayValidation";
import {
  ModuleHeader,
        ...
        actions={
          <>
            {page.config.primaryAction && page.permissions.canCreate ? (
              <Link
                href={`${WarehouseReceivingPutawayHref}/add`}
...
function WarehouseScopeNavigation({
  ...
  const options: AppAdvancedDropdownOption[] = [
    ...(allowAllWarehouses
      ? [
          {
            description: "Review inbound work across every accessible warehouse.",
            label: "ALL",
            name: "All Warehouses",
            value: "All",
          },
    ...
    ...warehouses.map((warehouse) => ({
      description: "Receiving, inspection, staging, and final putaway context.",
              ...
              >
                {cell.column.id === "status" ? (
                  ...
                  <ModuleTableActions className="w-full !justify-center">
                    <ModuleTableActionLink
                      href={`${WarehouseReceivingPutawayHref}/view/${row.original.id}`}
                      variant="view"
                      label={`View ${row.original.cells.document ?? page.config.title}`}
                    />
                    {page.permissions.canUpdate && !page.config.readOnly ? (
                      <ModuleTableActionLink
                        href={`${WarehouseReceivingPutawayHref}/edit/${row.original.id}`}
                        variant="edit"
