...
type WarehouseInventoryStockTableRowProps = {
	row: Row<WarehouseModuleRecord>;
};

export function WarehouseInventoryStockTableRow({
	row,
}: WarehouseInventoryStockTableRowProps) {
	return (
		<tr className="module-table-row">
			{row.getVisibleCells().map((cell) => (
				...
				>
					<WarehouseInventoryStockCellContent
...
function WarehouseInventoryStockCellContent({
	columnId,
	record,
	value,
}: {
