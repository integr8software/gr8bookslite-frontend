...
import { WarehouseItemAvailabilityPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-inventory/item-availability/WarehouseItemAvailabilityConstants";
import { useWarehouseItemAvailabilityListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-inventory/item-availability/useWarehouseItemAvailabilityListPage";
import type {
  WarehouseItemAvailabilityColumn,
...
import { validateWarehouseItemAvailabilityDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-inventory/item-availability/WarehouseItemAvailabilityValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseItemAvailabilityRecord | null;

export function WarehouseItemAvailabilityListPage() {
  const featureModule = "item-availability" as WarehouseItemAvailabilityModule;
  const page = useWarehouseItemAvailabilityListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseItemAvailabilityRecord) => void;
  page: ReturnType<typeof useWarehouseItemAvailabilityListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseItemAvailabilityRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseItemAvailabilityPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseItemAvailabilityRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseItemAvailabilityRecord;
  isPending: boolean;
  module: WarehouseItemAvailabilityModule;
  onClose: () => void;
  onSave: (record: WarehouseItemAvailabilityRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseItemAvailabilityDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseItemAvailabilityModule) {
