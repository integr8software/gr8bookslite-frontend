...
import { WarehouseStockByLocationPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-inventory/stock-by-location/WarehouseStockByLocationConstants";
import { useWarehouseStockByLocationListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-inventory/stock-by-location/useWarehouseStockByLocationListPage";
import type {
  WarehouseStockByLocationColumn,
...
import { validateWarehouseStockByLocationDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-inventory/stock-by-location/WarehouseStockByLocationValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseStockByLocationRecord | null;

export function WarehouseStockByLocationListPage() {
  const featureModule = "stock-by-location" as WarehouseStockByLocationModule;
  const page = useWarehouseStockByLocationListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseStockByLocationRecord) => void;
  page: ReturnType<typeof useWarehouseStockByLocationListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseStockByLocationRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseStockByLocationPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseStockByLocationRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseStockByLocationRecord;
  isPending: boolean;
  module: WarehouseStockByLocationModule;
  onClose: () => void;
  onSave: (record: WarehouseStockByLocationRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseStockByLocationDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseStockByLocationModule) {
