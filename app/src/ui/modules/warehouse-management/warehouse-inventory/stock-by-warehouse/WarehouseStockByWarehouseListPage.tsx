...
import { WarehouseStockByWarehousePaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-inventory/stock-by-warehouse/WarehouseStockByWarehouseConstants";
import { useWarehouseStockByWarehouseListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-inventory/stock-by-warehouse/useWarehouseStockByWarehouseListPage";
import type {
  WarehouseStockByWarehouseColumn,
...
import { validateWarehouseStockByWarehouseDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-inventory/stock-by-warehouse/WarehouseStockByWarehouseValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseStockByWarehouseRecord | null;

export function WarehouseStockByWarehouseListPage() {
  const featureModule = "stock-by-warehouse" as WarehouseStockByWarehouseModule;
  const page = useWarehouseStockByWarehouseListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseStockByWarehouseRecord) => void;
  page: ReturnType<typeof useWarehouseStockByWarehouseListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseStockByWarehouseRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseStockByWarehousePaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseStockByWarehouseRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseStockByWarehouseRecord;
  isPending: boolean;
  module: WarehouseStockByWarehouseModule;
  onClose: () => void;
  onSave: (record: WarehouseStockByWarehouseRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseStockByWarehouseDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseStockByWarehouseModule) {
