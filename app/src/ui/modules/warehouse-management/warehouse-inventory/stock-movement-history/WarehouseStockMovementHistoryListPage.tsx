...
import { WarehouseStockMovementHistoryPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-inventory/stock-movement-history/WarehouseStockMovementHistoryConstants";
import { useWarehouseStockMovementHistoryListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-inventory/stock-movement-history/useWarehouseStockMovementHistoryListPage";
import type {
  WarehouseStockMovementHistoryColumn,
...
import { validateWarehouseStockMovementHistoryDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-inventory/stock-movement-history/WarehouseStockMovementHistoryValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseStockMovementHistoryRecord | null;

export function WarehouseStockMovementHistoryListPage() {
  const featureModule = "stock-movement-history" as WarehouseStockMovementHistoryModule;
  const page = useWarehouseStockMovementHistoryListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseStockMovementHistoryRecord) => void;
  page: ReturnType<typeof useWarehouseStockMovementHistoryListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseStockMovementHistoryRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseStockMovementHistoryPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseStockMovementHistoryRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseStockMovementHistoryRecord;
  isPending: boolean;
  module: WarehouseStockMovementHistoryModule;
  onClose: () => void;
  onSave: (record: WarehouseStockMovementHistoryRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseStockMovementHistoryDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseStockMovementHistoryModule) {
