...
import { WarehouseLocationTransferPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-operations/location-transfer/WarehouseLocationTransferConstants";
import { useWarehouseLocationTransferListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-operations/location-transfer/useWarehouseLocationTransferListPage";
import type {
  WarehouseLocationTransferColumn,
...
import { validateWarehouseLocationTransferDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-operations/location-transfer/WarehouseLocationTransferValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseLocationTransferRecord | null;

export function WarehouseLocationTransferListPage() {
  const featureModule = "location-transfer" as WarehouseLocationTransferModule;
  const page = useWarehouseLocationTransferListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseLocationTransferRecord) => void;
  page: ReturnType<typeof useWarehouseLocationTransferListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseLocationTransferRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseLocationTransferPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseLocationTransferRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseLocationTransferRecord;
  isPending: boolean;
  module: WarehouseLocationTransferModule;
  onClose: () => void;
  onSave: (record: WarehouseLocationTransferRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseLocationTransferDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseLocationTransferModule) {
