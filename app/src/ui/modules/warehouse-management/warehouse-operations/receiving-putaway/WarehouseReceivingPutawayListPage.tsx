...
import { WarehouseReceivingPutawayPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-operations/receiving-putaway/WarehouseReceivingPutawayConstants";
import { useWarehouseReceivingPutawayListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-operations/receiving-putaway/useWarehouseReceivingPutawayListPage";
import type {
  WarehouseReceivingPutawayColumn,
...
import { validateWarehouseReceivingPutawayDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-operations/receiving-putaway/WarehouseReceivingPutawayValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseReceivingPutawayRecord | null;

export function WarehouseReceivingPutawayListPage() {
  const featureModule = "receiving-putaway" as WarehouseReceivingPutawayModule;
  const page = useWarehouseReceivingPutawayListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseReceivingPutawayRecord) => void;
  page: ReturnType<typeof useWarehouseReceivingPutawayListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseReceivingPutawayRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseReceivingPutawayPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseReceivingPutawayRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseReceivingPutawayRecord;
  isPending: boolean;
  module: WarehouseReceivingPutawayModule;
  onClose: () => void;
  onSave: (record: WarehouseReceivingPutawayRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseReceivingPutawayDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseReceivingPutawayModule) {
