...
import { WarehouseStockAdjustmentPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-operations/stock-adjustment/WarehouseStockAdjustmentConstants";
import { useWarehouseStockAdjustmentListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-operations/stock-adjustment/useWarehouseStockAdjustmentListPage";
import type {
  WarehouseStockAdjustmentColumn,
...
import { validateWarehouseStockAdjustmentDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-operations/stock-adjustment/WarehouseStockAdjustmentValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseStockAdjustmentRecord | null;

export function WarehouseStockAdjustmentListPage() {
  const featureModule = "stock-adjustment" as WarehouseStockAdjustmentModule;
  const page = useWarehouseStockAdjustmentListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseStockAdjustmentRecord) => void;
  page: ReturnType<typeof useWarehouseStockAdjustmentListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseStockAdjustmentRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseStockAdjustmentPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseStockAdjustmentRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseStockAdjustmentRecord;
  isPending: boolean;
  module: WarehouseStockAdjustmentModule;
  onClose: () => void;
  onSave: (record: WarehouseStockAdjustmentRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseStockAdjustmentDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseStockAdjustmentModule) {
