...
import { WarehouseItemLocationSetupPaginationStorageKey } from "@/app/src/constants/modules/warehouse-management/warehouse-storage/item-location-setup/WarehouseItemLocationSetupConstants";
import { useWarehouseItemLocationSetupListPage } from "@/app/src/hooks/modules/warehouse-management/warehouse-storage/item-location-setup/useWarehouseItemLocationSetupListPage";
import type {
  WarehouseItemLocationSetupColumn,
...
import { validateWarehouseItemLocationSetupDraft } from "@/app/src/validations/modules/warehouse-management/warehouse-storage/item-location-setup/WarehouseItemLocationSetupValidation";
import {
  ModuleHeader,
...
type ComposerState = "new" | WarehouseItemLocationSetupRecord | null;

export function WarehouseItemLocationSetupListPage() {
  const featureModule = "item-location-setup" as WarehouseItemLocationSetupModule;
  const page = useWarehouseItemLocationSetupListPage(featureModule);
...
function WorkspaceTable({
  ...
  onEditRecord: (record: WarehouseItemLocationSetupRecord) => void;
  page: ReturnType<typeof useWarehouseItemLocationSetupListPage>;
}) {
  ...
  const exportColumns = page.config.columns
    ...
    .map((column) => ({
      header: column.label,
      id: column.id,
      value: (record: WarehouseItemLocationSetupRecord) =>
  ...
  return (
    ...
    >
      <ModuleTable
        ...
        paginationStorageKey={`${WarehouseItemLocationSetupPaginationStorageKey}:${module}`}
        table={page.table}
...
function WorkspaceDetails({
  ...
  onClose: () => void;
  onEdit: () => void;
  record: WarehouseItemLocationSetupRecord | null;
  title: string;
}) {
  return (
...
function WorkspaceComposer({
  ...
  initialRecord?: WarehouseItemLocationSetupRecord;
  isPending: boolean;
  module: WarehouseItemLocationSetupModule;
  onClose: () => void;
  onSave: (record: WarehouseItemLocationSetupRecord) => Promise<unknown>;
  warehouseId: string;
  ...
  async function handleSubmit() {
    const validationError = validateWarehouseItemLocationSetupDraft({
      columns,
      status,
      values,
      warehouseId,
...
function getComposerStatuses(module: WarehouseItemLocationSetupModule) {
