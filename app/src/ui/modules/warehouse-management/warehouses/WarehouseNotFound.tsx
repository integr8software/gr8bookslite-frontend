...
export function WarehouseNotFound() {
  return (
    <section className="rounded-lg border border-darknavy/10 bg-white p-8 text-center shadow-sm">
      ...
      <h1 className="mt-4 text-xl font-semibold text-darknavy">Warehouse not found</h1>
      <p className="mx-auto mt-2 max-w-md text-sm text-darknavy/60">The warehouse may have been removed or the record identifier is invalid.</p>
      <Link href={WarehouseHref} className={`${moduleHeaderActionClassNames.primary} mt-5`}>
        Back to Warehouses
      </Link>
    </section>
  );
