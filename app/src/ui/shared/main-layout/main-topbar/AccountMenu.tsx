...
export function AccountMenu({
  ...
  return (
    <div className="relative" data-main-profile-root>
      ...
      {isOpen ? (
        <div
          className="fixed right-3 top-14 z-50 w-[calc(100vw-1.5rem)] max-w-72 overflow-hidden rounded-lg border border-darknavy/10 bg-white p-1 shadow-[0_24px_70px_rgba(33,39,56,0.18)] md:absolute md:right-0 md:top-12 md:w-72"
        >
          <AccountDetails
            companyName={
