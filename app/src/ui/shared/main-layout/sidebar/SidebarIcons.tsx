...
import type { MainIconName, MainNavigationItem } from "@/app/src/types/shared/main-layout/MainLayoutDomainTypes";
...
const SidebarItemIcons: Record<string, LucideIcon> = {
  ...
  "maintenance-project-maintenance": FolderKanban,
...
export function hasSidebarItemIcon(item: MainNavigationItem) {
  ...
  return Boolean((item.iconName && SidebarAllowedIcons[item.iconName]) || SidebarItemIcons[item.key]);
}

export function renderSidebarItemIcon(item: MainNavigationItem, isActive: boolean, isAncestorActive: boolean) {
