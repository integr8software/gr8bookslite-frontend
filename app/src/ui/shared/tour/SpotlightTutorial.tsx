  ...
  useEffect(() => {
    ...
    function scheduleRecordActionStateUpdate(isEnabled = true) {
      ...
      frameId = window.requestAnimationFrame(() => {
        ...
        setHasRecordActions(
          Boolean(document.querySelector("[data-spotlight-id='maintenance-record-actions']")),
        );
        setHasRecordEditAction(
          Boolean(document.querySelector("[data-spotlight-id='maintenance-record-edit']")),
        );
        setHasRecordStatusAction(
          Boolean(document.querySelector("[data-spotlight-id='maintenance-record-status']")),
        );
      });
    }
...
const MaintenanceModuleRoutePrefixes = [
...
function isMaintenanceModuleRoute(href: string) {
  return MaintenanceModuleRoutePrefixes.some((prefix) => href.startsWith(prefix));
}
