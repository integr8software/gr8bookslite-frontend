...
type TransactionFileAttachmentFieldsProps<
  TAttachment extends TransactionAttachment = TransactionAttachment,
> = {
...
export function TransactionFileAttachmentFields<
  TAttachment extends TransactionAttachment = TransactionAttachment,
>({
  attachments,
  inputId,
  ...
  uploadTitle,
  onAttachmentsChange,
}: TransactionFileAttachmentFieldsProps<TAttachment>) {
...
function formatAttachmentSizeLabel(attachment: TransactionAttachment) {
