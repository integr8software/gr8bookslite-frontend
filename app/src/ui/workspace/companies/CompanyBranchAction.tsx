...
import { useWorkspaceCompanyBranchAction } from "@/app/src/hooks/workspace/companies/useWorkspaceCompanyAction";
import type {
					...
					>
						<div className="grid grid-cols-2 gap-2">
							<ClassificationButton
								...
								label="Branch"
								onClick={() =>
									onUpdateField("branchType", "Branch")
								}
							/>
							<ClassificationButton
								...
								label="Satellite"
								onClick={() =>
									onUpdateField("branchType", "Satellite")
								}
							/>
						</div>
					</BranchField>
