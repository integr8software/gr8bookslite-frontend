...
function entryHasMissingRequiredFields(entry: DisbursementVoucherFormValues["lineEntries"][number]) {
...
function entryHasBothDebitAndCredit(entry: DisbursementVoucherFormValues["lineEntries"][number]) {
