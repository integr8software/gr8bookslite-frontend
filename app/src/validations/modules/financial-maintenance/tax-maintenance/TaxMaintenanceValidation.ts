import { z } from "zod";
import { TaxMaintenanceStatusOptions } from "@/app/src/constants/modules/financial-maintenance/tax-maintenance/TaxMaintenanceConstants";
import type {
...
export const TaxMaintenanceFormSchema = z.object({
  ...
  percentage: z
    ...
    .refine((value) => value === "" || hasAllowedDecimalPlaces(value, 4), {
