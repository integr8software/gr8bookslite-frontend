import { z } from "zod";
import type { WarehouseCapacityStorageRulesColumn } from "@/app/src/types/modules/warehouse-management/capacity-storage-rules/WarehouseCapacityStorageRulesTypes";
